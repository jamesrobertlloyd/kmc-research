...
Posterior predictive $p$-values (cite Rubin 1984, Meng 1994) are defined by\fTBD{check notation is up to date}
\begin{equation}
...
In particular, we fit a DBN with architecture $(784)\leftarrow(500)\leftarrow(500)\leftrightarrow(2000)\leftrightarrow(10)$ using RBM pre-training and generative fine tuning algorithm proposed in (\NA{cite Geoff again}).
