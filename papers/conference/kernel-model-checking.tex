...
\footnotetext{
Throughout this paper we estimate the null distribution of the MMD statistic using the bootstrap method described in \citep{Gretton2008-ik} using 1000 replicates.
We use a radial basis function kernel and select the lengthscale by 5 fold cross validation using predictive likelihood of the kernel density estimate as the selection criterion.}
...
Indeed, the data appears to have a hard lower bound which is inconsistent with Gaussianity.
