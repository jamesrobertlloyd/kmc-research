...
\footnotetext{
Throughout this paper we estimate the null distribution of the MMD statistic using the bootstrap method described in \citep{Gretton2008-gs} using 1000 replicates.
...
\footnotetext{For details see code at [redacted]}%\url{https://github.com/jamesrobertlloyd/kmc-research}}
...
In particular classical $p$-values test a null hypothesis that the data could have been generated by a class of distributions (\eg all normal distributions) whereas all other $p$-values test a particular probability distribution.
