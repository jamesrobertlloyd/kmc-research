...
\TBD{Be careful anout how you phrase the null hypothesis in the frequentist case. Note that the frequentist version would have very low power for \eg a neural net}

\paragraph{When can we ignore a discrepancy between a model and data?}

The test proposed in this paper indicates whether or not it is plausible that the data were generated by a fitted model or posterior distribution.
