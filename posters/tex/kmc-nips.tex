...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item The minimum value of the likelihood of data under a model (i.e.\ an outlier measure)
  \end{itemize}
...
Note that the main discrepancies between model and data (by this measure) are not near the outlier.
...
Q: Did we answer our central question of how to choose a statistic for model criticism?

A: Not really, but these methods are interesting since one can specify a statistic in high level terms e.g.\ `smooth function' rather than specifying an equation.
