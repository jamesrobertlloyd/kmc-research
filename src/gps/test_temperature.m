...
%% Fit a GP with custom covariance to this
...
hyp.cov = [1.2457 -1.0715 -0.2470 -6.8961 -0.4091];
hyp.mean = [];
hyp.lik = -1.6743;

cov_fn = {@covSum, {@covPeriodicNoDC, @covSEiso}};
...
if size(A,2) == 2
    ...
    colorbar;
    save2pdf('temp/witness.pdf', h, 900, true );
    hold off;
end